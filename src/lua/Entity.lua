...
function RadiusDamageMultiPoint(entities, centerOrigins, radius, fullDamage, doer, ignoreLOS, fallOffFunc, useXZDistance)
    ...
    for _, target in ipairs(entities) do
        ...
        for i, centerOrigin in ipairs(centerOrigins) do
            ...
            if (ignoreLOS or not wallBetween) and (distanceFromTarget <= radiusSquared) then
                ...
                break -- One of the point provided dealt damages, don't overdamage
