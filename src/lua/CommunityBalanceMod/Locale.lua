...
if Client then
	...
	Locale.substitutions["EXO_MODULE_FLAMETHROWER_DESC"] = "Fits any arm that takes a railgun, but not next to a minigun: the marine flamethrower's cone, 9 damage a tick out to 9 meters, setting aliens and structures on fire and burning away spores and umbra; bile bombs fly through it. It cannot weld. Light arm at 6% of the exosuit's speed for +40 armor, and it overheats after ten seconds."
