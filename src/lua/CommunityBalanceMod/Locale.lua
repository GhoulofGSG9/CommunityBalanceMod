...
if Client then
	...
	Locale.substitutions["EXO_MODULE_CLAW_DESC"] = "Left arm only: a 50 structural damage swing at melee range that never runs dry, and +90 armor for 4% of the exosuit's speed. It cannot shoot, so the right arm has to do the killing."
	Locale.substitutions["EXO_MODULE_MINIGUN_DESC"] = "Close range bullet hose with no ammo to reload: 6 heavy damage a round, the pick against big armored lifeforms. It overheats after three and a half seconds of held fire and is the heaviest arm, 10% of the exosuit's speed for +90 armor."
	Locale.substitutions["EXO_MODULE_RAILGUN_DESC"] = "Long range shot: charge for a second to take it from 20 to 120 structural damage, and the slug pierces every target in its line out to 30 meters. +60 armor for 6% of the exosuit's speed, so it wants to fight from the back."
	Locale.substitutions["EXO_MODULE_PLASMALAUNCHER"] = "Plasma Launcher"
	Locale.substitutions["EXO_MODULE_PLASMALAUNCHER_DESC"] = "Lobbed plasma charge: 35 damage in a 4 meter blast plus a lingering burn. A direct hit electrifies the alien it lands on for 3.5 seconds, stripping mucous and enzyme and slowing its attacks. Swarm control, not a siege weapon. One bomb from a full cell, then one every 2 seconds, for +60 armor and 8% of the exosuit's speed."
	Locale.substitutions["EXO_MODULE_FLAMETHROWER_DESC"] = "Fits any arm that takes a railgun, but not next to a minigun: a wider cone than the marine flamethrower's, 9 damage a tick out to 9 meters, setting aliens and structures on fire and burning away spores and umbra; bile bombs fly through it. It cannot weld. Light arm at 6% of the exosuit's speed for +40 armor, and it overheats after ten seconds."
	Locale.substitutions["EXO_MODULE_THRUSTERS"] = "Thrusters"
	Locale.substitutions["EXO_MODULE_THRUSTERS_DESC"] = "Core module: a ground dash worth 2.5 extra speed on demand, burning 4 energy a second out of the fuel cell. Good for closing on a target or breaking a chase; it gives no lift and costs 2.5% of the exosuit's speed."
